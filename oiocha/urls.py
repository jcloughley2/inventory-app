...
from collection.views import home, profile, browse, myhome, ListCreate, ListDetail, ListUpdate
...
urlpatterns = [
    ...
    path('u/<username>/',profile.as_view(template_name='index.html'),name='profile'),
    path('browse/',browse.as_view(template_name='index.html'), name='browse'),
    path('myhome/',myhome.as_view(template_name='index.html'), name='myhome'),
